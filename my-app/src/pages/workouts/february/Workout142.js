        ...
        <Carousel activeIndex={index} onSelect={handleSelect} interval={null} className={styles.CarouselMain}>
            <Carousel.Item className={styles.CarouselItem}>
                ...
                <Carousel.Caption className={`my-auto ${styles.CarouselContent}`}>
                    <h3 className='mb-4'>Date: Thur 20.02</h3>
                    <h3 className="mb-4">Body Parts: Chest, Triceps and Back</h3>
                    <h4>The last day of the pull/chin up 10 day challenge<br></br> Plus a Mini chest and tricep workout plus </h4>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className={styles.CarouselItem}>
                <img
            ...
            <Carousel.Item className={styles.CarouselItem}>
                ...
                <Carousel.Caption className={`my-auto ${styles.CarouselContent}`}>
                    <h3>Workout</h3>
                    <p>The last day of the 10 days 100 rep challenge for pull/chin ups (spread throughout the day)</p>
