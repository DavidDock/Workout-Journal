        ...
        <Carousel activeIndex={index} onSelect={handleSelect} interval={null} className={styles.CarouselMain}>
            <Carousel.Item className={styles.CarouselItem}>
                ...
                <Carousel.Caption className={`my-auto ${styles.CarouselContent}`}>
                    <h3 className='mb-4'>Date: Fri 14.02</h3>
                    <h3 className="mb-4">Body Parts: Cardio and Back</h3>
                </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item className={styles.CarouselItem}>
                <img
            ...
            <Carousel.Item className={styles.CarouselItem}>
                ...
                <Carousel.Caption className={`my-auto ${styles.CarouselContent}`}>
                    <h3>Workout</h3>
                    <p>Two mile run</p>
                    <p>Plus day 5 of the 10 day 100 rep pull/chin up challenge (spread throughout the day)</p><br></br>
                </Carousel.Caption>
            </Carousel.Item>
        </Carousel>
