        ...
        <Carousel activeIndex={index} onSelect={handleSelect} interval={null} className={styles.CarouselMain}>
            <Carousel.Item className={styles.CarouselItem}>
                ...
                <Carousel.Caption className={`my-auto ${styles.CarouselContent}`}>
                    <h3 className='mb-4'>Date: Mon 17.02</h3>
            ...
            <Carousel.Item className={styles.CarouselItem}>
                ...
                <Carousel.Caption className={`my-auto ${styles.CarouselContent}`}>
                    <h3>Workout</h3>
                    <h4>Murph</h4>
                    <p>This is a very large workout.</p>
                    <ul>
                        <li>1 Mile Run</li>
                        <li>10 pull-ups</li>
                        <li>200 press-ups</li>
                    ...
                    <p>This workout included day 7 of the pull/chin up challenge.</p>
                </Carousel.Caption>
            </Carousel.Item>
        </Carousel>
